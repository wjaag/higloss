<?php
/**
 * Minimal Sharp Footer with "hi" Square Logo
 *
 * @package HiGloss2026
 */
?>
...
<footer class="hg-footer">
    <div class="hg-container" style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
        <a href="<?php echo esc_url(home_url('/')); ?>" style="display: flex; align-items: center; gap: 0.8rem;">
            <div style="width: 40px; height: 40px; border: 2.5px solid #25aae1; background: #000000; display: flex; align-items: center; justify-content: center; font-family: 'Montserrat', sans-serif; font-weight: 900; font-size: 1.25rem; color: #25aae1; flex-shrink: 0;">
                hi
            </div>
...
<div class="hg-mobile-bar">
    ...
    <a href="<?php echo esc_url(home_url('/#wycena')); ?>" class="hg-m-btn">
        ⚡ Wycena
    </a>
