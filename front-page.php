            ...
            <div class="hg-work-grid">
                ...
                if ($projects->have_posts()) :
                    while ($projects->have_posts()) :
                        ...
                        ?>
                        <a class="hg-work-card hg-reveal" href="<?php the_permalink(); ?>" data-category="<?php echo esc_attr($cat_slug); ?>" data-lightbox-img="<?php echo esc_url($thumb); ?>" data-lightbox-before="<?php echo $before_url ? esc_url($before_url) : ''; ?>" data-lightbox-title="<?php the_title_attribute(); ?>" data-lightbox-meta="<?php echo esc_attr(($model_label ? $model_label . ' · ' : '') . ($service ?: 'HI-GLOSS Studio')); ?>" data-lightbox-desc="<?php echo esc_attr(wp_trim_words(get_the_excerpt() ? get_the_excerpt() : get_the_title(), 26, '…')); ?>" data-lightbox-link="<?php the_permalink(); ?>">
                            <?php
                    ...
                    foreach ($fallback_projects as $index => $project) :
                        ...
                        ?>
                        <a class="hg-work-card hg-reveal" href="<?php echo esc_url(home_url('/galeria')); ?>" data-category="<?php echo esc_attr($project[4]); ?>" data-lightbox-img="<?php echo esc_url($theme_uri . '/assets/images/' . $project[0]); ?>" data-lightbox-before="<?php echo $before_src ? esc_url($before_src) : ''; ?>" data-lightbox-title="<?php echo esc_attr($project[2]); ?>" data-lightbox-meta="<?php echo esc_attr($project[1] . ' · ' . $project[3]); ?>" data-lightbox-desc="<?php echo esc_attr($project[3]); ?>" data-lightbox-link="<?php echo esc_url(home_url('/' . $project[4])); ?>">
