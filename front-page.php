<?php
/**
 * Template Name: Sharp Architectural "Less is More" Edition
 *
 * @package HiGloss2026
 */
...
<!-- SECTION 1: HERO (WHITE BACKGROUND + BLACK BORDER ACCENTS) -->
<section class="sec-hero">
    <div class="hg-container hg-grid hg-grid-2" style="align-items: center;">
        <div>
            <div style="display: inline-block; padding: 0.35rem 0.8rem; background: #000000; color: #ffffff; font-weight: 800; font-size: 0.8rem; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 1.5rem;">
            ...
            <h1 style="font-family: var(--font-heading); font-size: clamp(2.5rem, 4.5vw, 4rem); font-weight: 900; line-height: 1.1; color: #000000; margin-bottom: 1.25rem; text-transform: uppercase;">
                SZTU KA ZMIANY KOLORU & <span style="color: #25aae1;">OCHRONA PPF</span>
            </h1>
            ...
            <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                <a href="#wycena" class="hg-btn hg-btn-black">
                    BEZPŁATNA WYCENA &rarr;
                </a>
                <a href="#uslugi" class="hg-btn hg-btn-blue">
                    ZOBACZ USŁUGI
                </a>
            </div>
        </div>
...
<!-- SECTION 2: USŁUGI (VIBRANT SAPPHIRE BLUE BACKGROUND) -->
<section id="uslugi" class="sec-services">
    <div class="hg-container">
        <div style="margin-bottom: 3rem;">
            <div style="display: inline-block; padding: 0.3rem 0.8rem; background: #ffffff; color: #1d4ed8; font-weight: 800; font-size: 0.8rem; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 0.75rem;">
                OFERTA
            </div>
            <h2 style="font-family: var(--font-heading); font-size: clamp(2rem, 3.5vw, 3rem); font-weight: 900; color: #ffffff; text-transform: uppercase; margin: 0;">
                KONTROLA JAKOŚCI & SZACOWANIE
            </h2>
        </div>

        <div class="hg-grid hg-grid-3">
            <div class="hg-card hg-card-blue">
                <div style="font-family: var(--font-heading); font-size: 2.2rem; font-weight: 900; color: #25aae1; margin-bottom: 0.5rem;">01</div>
                ...
                <a href="#wycena" class="hg-btn hg-btn-white" style="padding: 0.6rem 1.2rem; font-size: 0.8rem;">
                    Wycena &rarr;
                </a>
            </div>

            <div class="hg-card hg-card-blue">
                <div style="font-family: var(--font-heading); font-size: 2.2rem; font-weight: 900; color: #25aae1; margin-bottom: 0.5rem;">02</div>
                <h3 style="font-family: var(--font-heading); font-size: 1.3rem; font-weight: 900; color: #ffffff; text-transform: uppercase; margin-bottom: 0.75rem;">
                    Bezbarwne PPF
                </h3>
                <p style="color: #cbd5e1; font-size: 0.95rem; margin-bottom: 1.5rem;">
            ...
            <div class="hg-card hg-card-blue">
                <div style="font-family: var(--font-heading); font-size: 2.2rem; font-weight: 900; color: #25aae1; margin-bottom: 0.5rem;">03</div>
                <h3 style="font-family: var(--font-heading); font-size: 1.3rem; font-weight: 900; color: #ffffff; text-transform: uppercase; margin-bottom: 0.75rem;">
                    Reklama & Floty
                </h3>
                <p style="color: #cbd5e1; font-size: 0.95rem; margin-bottom: 1.5rem;">
...
<!-- SECTION 3: REALIZACJE (DARK ONYX BACKGROUND) -->
    ...
    <div class="hg-container">
        <div style="margin-bottom: 3rem; display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 1rem;">
            ...
            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                <button class="hg-btn hg-btn-blue hg-filter-btn active" data-category="all" style="padding: 0.4rem 1rem; font-size: 0.8rem;">Wszystkie</button>
                <button class="hg-btn hg-btn-black hg-filter-btn" data-category="zmiana-koloru" style="padding: 0.4rem 1rem; font-size: 0.8rem; border-color: rgba(255,255,255,0.2);">Zmiana Koloru</button>
                <button class="hg-btn hg-btn-black hg-filter-btn" data-category="ppf" style="padding: 0.4rem 1rem; font-size: 0.8rem; border-color: rgba(255,255,255,0.2);">PPF Ochrona</button>
                <button class="hg-btn hg-btn-black hg-filter-btn" data-category="reklama" style="padding: 0.4rem 1rem; font-size: 0.8rem; border-color: rgba(255,255,255,0.2);">Reklama & Floty</button>
            </div>
        </div>

        <div class="hg-grid hg-grid-3">
            <div class="hg-card hg-card-dark hg-gallery-item" data-category="zmiana-koloru" style="padding: 0; overflow: hidden;">
            ...
            <div class="hg-card hg-card-dark hg-gallery-item" data-category="ppf" style="padding: 0; overflow: hidden;">
...
<!-- SECTION 4: WYCENA & KONTAKT (DEEP CHARCOAL BACKGROUND) -->
        ...
        <div class="hg-grid hg-grid-2">
            ...
            <div class="hg-card hg-card-dark" id="hgQuoteCalculator">
                ...
                <form id="hgCalcForm">
                    ...
                    <button type="submit" class="hg-btn hg-btn-blue" style="width: 100%;">
