...
<main id="main-content" class="hg-landing">
    ...
    <?php get_template_part('template-parts/front-page/materials'); ?>
    ...
    <?php
    // Sekcja szkoleń, CTA, FAQ i kontakt pozostają w istniejącym template.
    ?>
    <section class="hg-section hg-services" id="szkolenia" aria-labelledby="szkolenia-title">
        <div class="hg-container">
            <header class="hg-section-heading hg-reveal">
                <div><p class="hg-kicker">05 · Szkolenia</p><h2 id="szkolenia-title">Uczymy kleić tak,<br><span>jak kleimy na zlecenia.</span></h2></div>
            ...
            <div class="hg-service-grid">
                <article class="hg-service-card hg-reveal"><div class="hg-service-image"><img src="<?php echo esc_url($theme_uri . '/assets/images/ai_oferta_zmiana_koloru.webp'); ?>" alt="Trener podczas szkolenia z oklejania auta folią" width="1408" height="768" loading="lazy"><span>01</span><p>Podstawy</p></div><div class="hg-service-body"><h3>Podstawy i zmiana koloru</h3><p>Przygotowanie lakieru, narzędzia, cięcie i praca na krzywiznach, a następnie pełna zmiana koloru z demontażem i zawijaniem folii w głąb elementów.</p><ul><li><span>Format</span><strong>Grupy 2–4 os.</strong></li><li><span>Poziom</span><strong>Od zera</strong></li></ul><a href="<?php echo esc_url(home_url('/szkolenia')); ?>" class="hg-text-link">Poznaj program szkoleń</a></div></article>
                <article class="hg-service-card hg-reveal"><div class="hg-service-image"><img src="<?php echo esc_url($theme_uri . '/assets/images/ai_oferta_ppf.webp'); ?>" alt="Aplikacja folii ochronnej PPF podczas szkolenia" width="1408" height="768" loading="lazy"><span>02</span><p>Ochrona</p></div><div class="hg-service-body"><h3>Ochrona PPF</h3><p>Praca z folią poliuretanową: strefy aplikacji, wykończenia krawędzi i właściwości samoregeneracji mikrorys pod wpływem ciepła.</p><ul><li><span>Format</span><strong>Indywidualnie</strong></li><li><span>Poziom</span><strong>Średni</strong></li></ul><a href="<?php echo esc_url(home_url('/szkolenia')); ?>" class="hg-text-link">Poznaj moduł PPF</a></div></article>
                <article class="hg-service-card hg-reveal"><div class="hg-service-image"><img src="<?php echo esc_url($theme_uri . '/assets/images/ai_oferta_reklama.webp'); ?>" alt="Szkolenie z oklejania reklamowego pojazdów firmowych" width="1408" height="768" loading="lazy"><span>03</span><p>Branding</p></div><div class="hg-service-body"><h3>Reklama i branding flot</h3><p>Wielkoformatowa grafika, druk i aplikacja na pojazdach firmowych — dla działów marketingu i flot, które chcą oklejać samodzielnie.</p><ul><li><span>Format</span><strong>Dla firm</strong></li><li><span>Poziom</span><strong>Dowolny</strong></li></ul><a href="<?php echo esc_url(home_url('/szkolenia')); ?>" class="hg-text-link">Poznaj moduł branding</a></div></article>
                <article class="hg-service-card hg-reveal"><div class="hg-service-image"><img src="<?php echo esc_url($theme_uri . '/assets/images/ai_oferta_szkolenia.webp'); ?>" alt="Trener HI-GLOSS DESIGN uczy kursantów aplikacji folii w hali w Mierzynie" width="1408" height="768" loading="lazy"><span>+</span><p>Certyfikat</p></div><div class="hg-service-body"><h3>Materiały i certyfikat w cenie</h3><p>Folie premium, narzędzia i sprzęt grzewczy zapewniamy na miejscu. Po szkoleniu otrzymujesz certyfikat oraz konsultacje po wdrożeniu.</p><ul><li><span>Miejsce</span><strong>Hala Mierzyn</strong></li><li><span>Termin</span><strong>Do ustalenia</strong></li></ul><a href="<?php echo esc_url(home_url('/kontakt')); ?>" class="hg-text-link">Zapytaj o termin</a></div></article>
            </div>
        </div>
    </section>

    <section class="hg-cta-band" aria-label="Zaproszenie do kontaktu">
        <div class="hg-cta-track" aria-hidden="true"><span>Zmień kolor</span><i></i><span>Chroń lakier</span><i></i><span>Wyróżnij markę</span><i></i><span>Zmień kolor</span><i></i><span>Chroń lakier</span><i></i></div>
        <div class="hg-container hg-cta-content hg-reveal"><p>Masz pomysł na swoje auto?</p><h2>My wiemy, jak go zrealizować.</h2><a href="#wycena" class="hg-btn hg-btn-primary">Porozmawiajmy o projekcie</a></div>
    </section>

    <section class="hg-section hg-faq" aria-labelledby="faq-title">
        <div class="hg-container hg-faq-layout">
            <header class="hg-faq-heading hg-reveal"><p class="hg-kicker">06 · Warto wiedzieć</p><h2 id="faq-title">Najczęstsze<br><span>pytania.</span></h2><p>Nie widzisz odpowiedzi? Zadzwoń — doradzimy rozwiązanie dopasowane do Twojego auta.</p><a href="tel:+48605088065" class="hg-text-link">605&nbsp;088&nbsp;065</a></header>
            <div class="hg-accordion hg-reveal">
                <details open><summary>Czy folia do zmiany koloru chroni lakier?<span></span></summary><div><p>Folia zmieniająca kolor stanowi dodatkową warstwę i ogranicza drobne uszkodzenia eksploatacyjne, jednak do ochrony przed kamieniami i głębszymi zarysowaniami przeznaczona jest grubsza, poliuretanowa folia PPF.</p></div></details>
                <details><summary>Jak długo trwa oklejenie całego auta?<span></span></summary><div><p>Standardowa zmiana koloru zajmuje zwykle 3–5 dni roboczych. Dokładny termin zależy od wielkości i konstrukcji auta, zakresu demontażu oraz wybranego materiału.</p></div></details>
                <details><summary>Czy folię można później bezpiecznie usunąć?<span></span></summary><div><p>Tak. Prawidłowo zaaplikowana folia renomowanego producenta może zostać profesjonalnie usunięta bez naruszania fabrycznego lakieru, o ile lakier był wcześniej w dobrym stanie.</p></div></details>
                <details><summary>Jaki pakiet PPF wybrać?<span></span></summary><div><p>Do jazdy miejskiej często wystarcza ochrona stref najbardziej narażonych. Przy częstych trasach rekomendujemy Full Front, a dla nowych, sportowych i kolekcjonerskich aut — Full Body.</p></div></details>
                <details><summary>Co jest potrzebne do przygotowania wyceny?<span></span></summary><div><p>Podaj markę, model i rocznik auta, interesującą Cię usługę oraz oczekiwany efekt. Zdjęcia i informacja o stanie lakieru pomogą nam przygotować bardziej precyzyjną propozycję.</p></div></details>
            </div>
        </div>
    </section>
    ...
    <section class="hg-contact" id="kontakt" aria-labelledby="contact-title">
        <div class="hg-container">
            <header class="hg-section-heading hg-contact-heading hg-reveal"><div><p class="hg-kicker">07 · Kontakt</p><h2 id="contact-title">Zacznijmy<br><span>Twój projekt.</span></h2></div><p>Opowiedz nam o aucie i oczekiwanym efekcie. Wrócimy z rekomendacją zakresu, materiału i orientacyjnym terminem.</p></header>
            <div class="hg-contact-grid" id="wycena">
                <div class="hg-contact-panel hg-reveal">
                    <p class="hg-contact-label">HI-GLOSS DESIGN</p><a class="hg-contact-phone" href="tel:+48605088065">605&nbsp;088&nbsp;065</a>
                    <div class="hg-contact-details"><div><span>Studio</span><a href="https://www.google.com/maps/dir/?api=1&destination=Podmiejska+4%2C+72-006+Mierzyn" target="_blank" rel="noopener noreferrer">ul. Podmiejska 4,<br>72-006 Mierzyn / Szczecin</a></div><div><span>E-mail</span><a href="mailto:biuro@hi-glossdesign.pl">biuro@hi-glossdesign.pl</a></div><div><span>Godziny</span><p>Pon.–Pt. 09:00–17:00<br>Sobota: po umówieniu</p></div></div>
                    <div class="hg-contact-socials"><a href="<?php echo esc_url($instagram_url); ?>" target="_blank" rel="noopener noreferrer"><span>Instagram<small>@higlossdesign</small></span></a><a href="<?php echo esc_url($facebook_url); ?>" target="_blank" rel="noopener noreferrer"><span>Facebook<small>Hi-gloss design Szczecin</small></span></a></div>
                </div>
                <div class="hg-form-panel hg-reveal"><div class="hg-form-heading"><span>Bezpłatna wycena</span><h3>Opowiedz nam o swoim aucie</h3></div><form class="hg-quote-form" id="hgQuoteForm" novalidate><div class="hg-form-row"><label><span>Imię i nazwisko</span><input type="text" name="name" autocomplete="name" placeholder="Jan Kowalski"></label><label><span>Numer telefonu <em>*</em></span><input type="tel" name="phone" autocomplete="tel" inputmode="tel" placeholder="600 000 000" required></label></div><div class="hg-form-row"><label><span>Adres e-mail</span><input type="email" name="email" autocomplete="email" placeholder="jan@email.pl"></label><label><span>Interesująca usługa <em>*</em></span><select name="service" required><option value="">Wybierz usługę</option><option value="Całościowa zmiana koloru">Całościowa zmiana koloru</option><option value="Bezbarwna folia PPF">Bezbarwna folia PPF</option><option value="Reklama i branding floty">Reklama i branding floty</option><option value="Przyciemnianie szyb / dechroming">Szyby / dechroming</option><option value="Inna usługa">Inna usługa</option></select></label></div><label><span>Auto i oczekiwany efekt</span><textarea name="notes" rows="4" placeholder="Marka, model, rocznik i krótki opis projektu..."></textarea></label><input type="text" name="website" class="hg-honeypot" tabindex="-1" autocomplete="off" aria-hidden="true"><label class="hg-consent"><input type="checkbox" name="consent" value="1" required><span>Wyrażam zgodę na kontakt w sprawie wyceny. Zapoznałem/am się z <a href="<?php echo esc_url(home_url('/polityka-prywatnosci')); ?>">polityką prywatności</a>. <em>*</em></span></label><div class="hg-form-submit"><button type="submit" class="hg-btn hg-btn-primary">Wyślij zapytanie</button><p>Pola oznaczone * są wymagane.</p></div><div class="hg-form-status" id="hgFormStatus" role="status" aria-live="polite"></div></form></div>
            </div>
            <div class="hg-map hg-reveal"><iframe title="Mapa dojazdu do HI-GLOSS DESIGN w Mierzynie" src="https://www.google.com/maps?q=Podmiejska+4,+72-006+Mierzyn&output=embed" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen></iframe><div class="hg-map-caption"><span>53.4275° N · 14.4711° E</span><a href="https://www.google.com/maps/dir/?api=1&destination=Podmiejska+4%2C+72-006+Mierzyn" target="_blank" rel="noopener noreferrer">Wyznacz trasę</a></div></div>
        </div>
    </section>
</main>
