 ...
 *
 * Karty etapowe ze zdjeciem w tle (hg-step-card + inline bg), karty
 * tekstowe z ikona-watermark w tle (hg-bg-icon). Fraza: "jak wyglada
 * oklejanie auta".
 *
 * @package HiGloss2026
 */
...
// Wspolny cien nad zdjeciowa karta (czytelny tekst na kazdym tle)
...
<main id="main-content" style="padding: 7.5rem 0 5rem; flex: 1;">
    <div class="hg-container">
        ...
        <section style="margin-top: 3rem;" aria-labelledby="proces-kroki">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok1.webp'); ?>');">
                <div class="hg-step-body">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok2.webp'); ?>');">
                <div class="hg-step-body">
                    <div class="hg-step-head">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok3.webp'); ?>');">
                <div class="hg-step-body">
                    <div class="hg-step-head">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok4.webp'); ?>');">
                <div class="hg-step-body">
                    <div class="hg-step-head">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok5.webp'); ?>');">
                <div class="hg-step-body">
                    <div class="hg-step-head">
                    ...
                    <p class="hg-step-text">Oklejamy w zamkniętym, <strong>ogrzewanym pomieszczeniu</strong> — bez kurzu i wahań temperatury, które psują wiązanie kleju. Pilnujemy naprężeń folii na przetłoczeniach, zawijamy krawędzie elementów i <strong>nie tniemy po lakierze</strong> — docięcia wykonujemy na zdjętych częściach lub w kanalikach fabrycznych.</p>
                </div>
                <aside class="hg-step-aside">
            ...
            <article class="hg-editorial-card hg-step-card hg-reveal" style="background-image: <?php echo $hg_step_shade; ?>, url('<?php echo esc_url($theme_uri . '/assets/images/proces_krok6.webp'); ?>');">
                <div class="hg-step-body">
                    <div class="hg-step-head">
        ...
        <div class="hg-editorial-card" style="margin-top: 3rem; padding: 2.2rem; position: relative; overflow: hidden;">
            <svg class="hg-bg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm1 5h-2v6l5.2 3.1 1-1.7-4.2-2.4z"/></svg>
            ...
            <h2 style="font-family: var(--hg-heading); font-size: clamp(1.3rem, 2.5vw, 1.9rem); font-weight: 900; color: #ffffff; text-transform: uppercase; margin-bottom: 1.2rem; position: relative;">
                Od czego zależy termin oklejenia?
            </h2>
            <ul style="color: #cbd5e1; line-height: 1.9; margin-left: 1.2rem; font-size: 0.98rem; position: relative; max-width: 720px;">
                ...
                <li><strong style="color:#fff;">Stan lakieru</strong> — ewentualną korektę lub usunięcie starej folii dodajemy do harmonogramu, zawsze po Twojej akceptacji.</li>
            </ul>
        </div>

        <!-- STANDARDY -->
        <div class="hg-editorial-card" style="margin-top: 1.5rem; padding: 2.2rem; position: relative; overflow: hidden;">
            <svg class="hg-bg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm5.3 6.3-6.6 6.6-3.4-3.4 1.4-1.4 2 2 5.2-5.2z"/></svg>
            <span style="color: #25aae1; font-family: var(--hg-heading); font-size: 0.8rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.15em; display: block; margin-bottom: 0.8rem;">
                W CENIE KAŻDEJ REALIZACJI
            </span>
            <h2 style="font-family: var(--hg-heading); font-size: clamp(1.3rem, 2.5vw, 1.9rem); font-weight: 900; color: #ffffff; text-transform: uppercase; margin-bottom: 1.4rem; position: relative;">
                Nasze standardy, nie dopłaty
            </h2>
            <div class="hg-gallery-specs-row" style="row-gap: 0.7rem; position: relative;">
        ...
        <section style="margin-top: 3rem;" aria-labelledby="proces-faq">
            ...
            <div class="hg-gallery-grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));">
                <div class="hg-editorial-card" style="padding: 1.8rem; position: relative; overflow: hidden;">
                    <svg class="hg-bg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4L14 13l-3-3 3.7-3.7Z"/></svg>
                    <h3 style="font-family: var(--hg-heading); color: #25aae1; font-size: 0.95rem; text-transform: uppercase; margin-bottom: 0.7rem; position: relative;">Muszę jakoś przygotować auto?</h3>
                    <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin: 0; position: relative;">Nie — mycie i całą dekontaminację wykonujemy u nas. Wystarczy, że przywozisz auto z w miarę pustym wnętrzem (demontujemy elementy nadwozia, ale nie sprzątamy kabiny).</p>
                </div>
                <div class="hg-editorial-card" style="padding: 1.8rem; position: relative; overflow: hidden;">
                    <svg class="hg-bg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    <h3 style="font-family: var(--hg-heading); color: #25aae1; font-size: 0.95rem; text-transform: uppercase; margin-bottom: 0.7rem; position: relative;">Zostaję bez auta na kilka dni — skąd wiadomo, co się z nim dzieje?</h3>
                    <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin: 0; position: relative;">Na życzenie wysyłamy zdjęcia z postępu prac po każdym etapie. Auto stoi w zamkniętej, monitorowanej hali — odbierasz je umyte, z listą wykonanych czynności.</p>
                </div>
                <div class="hg-editorial-card" style="padding: 1.8rem; position: relative; overflow: hidden;">
                    <svg class="hg-bg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm5.3 6.3-6.6 6.6-3.4-3.4 1.4-1.4 2 2 5.2-5.2z"/></svg>
                    <h3 style="font-family: var(--hg-heading); color: #25aae1; font-size: 0.95rem; text-transform: uppercase; margin-bottom: 0.7rem; position: relative;">Co jeśli coś się odklei po czasie?</h3>
                    <p style="color: #cbd5e1; font-size: 0.95rem; line-height: 1.7; margin: 0; position: relative;">To objęte gwarancją aplikacji — przyjeżdżasz, doklejamy element bez dyskusji. Gwarancja na folię to 7 lat (kolor) i 10 lat (PPF), a za wykonanie odpowiadamy własnym imieniem.</p>
                </div>
            </div>
        </section>
