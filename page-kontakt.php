<?php
/**
 * Template Name: Podstrona Kontakt (Informacje, Mapka, Dedykowany Formularz CSS)
 *
 * @package HiGloss2026
 */
...
<main style="padding: 10rem 0 6rem; flex: 1;">
    <div class="hg-container">
        ...
        <!-- 3. DEDYKOWANY SYSTEM FORMULARZA ROZCIĄGNIĘTY NA 100% SZEROKOŚCI -->
        <div class="hg-form-box" id="kalkulator">
            ...
            <form id="hgCalcForm">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
                    <div class="hg-field-group">
                        <label class="hg-label">Wybierz Usługę *</label>
                        <select id="calcServiceSelect" class="hg-select-field">
                    ...
                    <div class="hg-field-group">
                        <label class="hg-label">Imię i Nazwisko *</label>
                        <input type="text" id="calcName" class="hg-input-field" placeholder="np. Jan Kowalski" required>
                    </div>

                    <div class="hg-field-group">
                        <label class="hg-label">Numer Telefonu *</label>
                        <input type="tel" id="calcPhone" class="hg-input-field" placeholder="np. 605 088 065" required>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
                    <div class="hg-field-group">
                        <label class="hg-label">Adres E-mail</label>
                        <input type="email" id="calcEmail" class="hg-input-field" placeholder="np. biuro@domena.pl">
                    </div>

                    <div class="hg-field-group">
                        <label class="hg-label">Marka, Model & Uwagi Do Zapytania</label>
                        <textarea id="calcNotes" class="hg-textarea-field" placeholder="np. Audi A7 2022, zmiana koloru na czarną satynę..." rows="3"></textarea>
                    </div>
                </div>

                <!-- Action Submit Button -->
                <button type="submit" class="hg-submit-btn">
