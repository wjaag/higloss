...
<main id="main-content" class="hg-landing">
    <section class="hg-hero hg-page-hero" aria-labelledby="hero-title">
        <img class="hg-hero-media" src="<?php echo esc_url($theme_uri . '/assets/images/ai_tile2_oferta.webp'); ?>" alt="HI-GLOSS DESIGN — studio oklejania samochodów, Szczecin / Mierzyn" width="1408" height="768" fetchpriority="high">
